...
N_SHARDS_PER_CORPUS_PER_SPLIT_PUBMED: Dict[str, Dict[str, int]] = {
    "Shuffled": {"train": 128, "val": 8},
}

DATA_URL_BY_CORPUS: Dict[str, str] = {
    "Shuffled": "https://storage.googleapis.com/pubmed-mosaic/pubmed-sharded/"
           "pubmedShuffled_{split}.{index}-of-{n_shards}.jsonl.gz"
}
...
class PubMedShuffled(datasets.GeneratorBasedBuilder):
    """
