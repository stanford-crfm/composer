...
Each logger backend inherits from :class:`~composer.core.logging.base_backend.LoggerBackend`,
...
.. code-block:: python
    ...
    from composer.core.logging import LoggerBackend

    class MyLoggerBackend(LoggerBackend)
