...
class Alibi(Algorithm):
    """
    Alibi dispenses with position embeddings and instead directly biases attention
    ...
    Parameters:
        heads_per_layer (`int`, *optional*):
            number of attention heads per layer
        max_sequence_length (`int`):
            maximum sequence length that the model will
            be able to accept without returning an error.
    """
